    ...
    .vertices =
        {
            ...
            {{-0.65, -0.35, -0.45, 1.0}, {1.0, 0.0, 0.0}},  // 0
            {{+0.25, -0.35, -0.45, 1.0}, {0.0, 1.0, 0.0}},  // 1
            {{+0.25, +0.55, -0.45, 1.0}, {0.0, 0.0, 1.0}},  // 2
            {{-0.65, +0.55, -0.45, 1.0}, {1.0, 1.0, 0.0}},  // 3

            // Front layer: z = +0.45
            // Сдвинута вправо и вниз относительно back layer:
            // видны top и right side в ортографической проекции
            {{-0.25, -0.65, +0.45, 1.0}, {1.0, 0.0, 1.0}},  // 4
            {{+0.65, -0.65, +0.45, 1.0}, {0.0, 1.0, 1.0}},  // 5
            {{+0.65, +0.25, +0.45, 1.0}, {1.0, 1.0, 1.0}},  // 6
            {{-0.25, +0.25, +0.45, 1.0}, {0.3, 0.3, 0.3}},  // 7
        },
